    ...
    <div>
      ...
      <div className="try">
          ...
          {categoryProductList.catProductType.map((catprolist, key) => {
            return (
              <div className="sneakers__categories__item-group">
                <div className="sneakers_item-name" key={key.tag}>
                  <p className="sneaker-tag">{catprolist.tag}</p>
                  <h2 className="sneaker-name">{catprolist.name}</h2>
                </div>
                <div className="imagecnt">
                  <img src={`${catprolist.image}`} alt="" />
                </div>{" "}
                <div className="price-cnt">
                  <p className="lowask">Lowest Ask</p>
                  <p className="sneaker-price">{catprolist.price}</p>
                </div>
              </div>
            );
          })}
        ...
        <section className="difference">
          {differenceList.differenceitem.map((difference, key) => {
            return (
              <div className="difference_item" key={key.title1}>
                {difference.svg}
                <h2 className="difference_typo">
                  {difference?.title3}
                  <span className={difference.spanName}>
                    {difference.title1}
                  </span>
                  {difference.title2}
                </h2>
