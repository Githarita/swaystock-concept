      ...
      <div className="buying-info-containerr">
        <div className="howitworkscnt">
          <div className="howitworkstop">
            <div
              className="howitworkstopitem howbosd"
              ...
              <div className="howitworksbottombuy">
                ...
                <div className="hiwbbnameprice">
                  ...
                  <p>
                    ...
                    prices move on your Bids. Bids can be renewed or let go when
                    they're about to expire, and you'll be notified ahead of
                    time
                  </p>
                </div>
                ...
                <div className="hiwbbnameprice">
                  ...
                  <p>
                    Discover and shop the products you love from around the
                    world. Doesn't matter if it's a recently sold out console or
                    an internationally exclusive product, you can always find
                    them available for purchase on our marketplace.
                  </p>
                </div>
                ...
                <div className="hiwbbnameprice">
                  ...
                  <p>
                    ...
                    They'll verify and make sure every item you buy is
                ...
                <div className="stepsonsuccess">
                  ...
                  <div className="stepsonsuccess-item">
                    <h2>Bid or Buy</h2>
                    <p>
                      On SwayStock there are two ways to buy: Bid at the price
                      of your choice and watch our dynamic marketplace come to
                      life, or Buy Now at the lowest Ask to secure your item
                      without any gamesmanship.
                    </p>
                  </div>
                  <div className="stepsonsuccess-item">
                    <h2>We Authenticate</h2>
                    <p>
                      Kick back and relax while we get to work. We make sure
                      items are shipped ASAP for verification. Once we verify
                      it's 100% authentic, we ship it off to you! Our average
                      delivery time is 7-12 busines days from order date.
                    </p>
                  </div>
                  <div className="stepsonsuccess-item">
                    ...
                    <p>
                      ...
                      your way ASAP. Once it arrives you should feel free to
                      flex on everyone by sharing with the hashtag
                      #GotItOnSwayStock. We'll be sure to show you some love as
                      well.
                    </p>
                  </div>
                </div>
            ...
            {active === "sell" && (
              <div className="howitworksbottombuy">
                ...
                <div className="hiwbb">
                  ...
                  <p>
                    Whether you're looking to make quick cash or start a
                    reselling business, we have the tools to help you succeed.
                  </p>
                </div>
                ...
                <div className="hiwbbnameprice">
                  ...
                  <p>
                    ...
                    need to take product pictures, share personal information,
                    or negotiate with potential Buyers.
                  </p>
                </div>
                ...
                <div className="hiwbbnameprice">
                  ...
                  <p>
                    Our global reach extends to millions of customers in
                    Nigeria. You're guaranteed to discover someone who can't
                    wait to purchase the item you're selling.
                  </p>
                </div>
                ...
                <div className="stepsonsuccess">
                  ...
                  <div className="stepsonsuccess-item">
                    ...
                    <p>
                      ...
                      business days. Simply print the label we send and follow
                      our shipping guidelines to ensure your products arrive
                      safely at our authentication center.
                    </p>
                  </div>
                  <div className="stepsonsuccess-item">
                    <h2>Get Paid</h2>
              ...
              <div className="howitworksbottombuy">
                ...
                <div className="hiwbtrustproc">
                  ...
                  <p>
                    ...
                    multi-step verification procedure that includes the
